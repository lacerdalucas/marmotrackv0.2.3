...
async function proxy(request) {
    ...
    if (user) {
        ...
        if (currentPath.startsWith('/login')) {
            ...
            const url = request.nextUrl.clone();
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$permissions$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["canViewDashboard"])(userRole)) url.pathname = '/dashboard';
            else url.pathname = '/scanner';
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(url);
        }
        // Proteger acesso indevido "Cross-Role"
        if (userRole) {
            if (currentPath.startsWith('/dashboard') && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$permissions$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["canViewDashboard"])(userRole)) {
                // Operador tentando ver relatórios web => Joga de volta pro scanner
                const url = request.nextUrl.clone();
                url.pathname = '/scanner';
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(url);
            }
            if (currentPath.startsWith('/scanner') && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$permissions$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["canViewScanner"])(userRole)) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bcad9b2e._.js.map