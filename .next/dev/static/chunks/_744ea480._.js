...
"[project]/app/actions/data:fd8d8e [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$fd8d8e__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:fd8d8e [app-client] (ecmascript) <text/javascript>");
...
function EditarPedidoForm({ initialData, pedidoId }) {
    ...
    const onSubmit = async (data)=>{
        ...
        try {
            ...
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$fd8d8e__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["atualizarPedidoComercial"])(pedidoId, formData);
            if (res.success) {
                setServerState({
                    type: 'success',
                    msg: res.message
...
//# sourceMappingURL=_744ea480._.js.map